...
def main() -> None:
    ...
    parser.add_argument("csv", help="CSV with columns price, liquidity, depth, tx_count")
    ...
    model = train_price_model(prices, liq, depth, tx, seq_len=args.seq_len, epochs=args.epochs)
