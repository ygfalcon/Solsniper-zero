...
from solhunter_zero.bootstrap_utils import ensure_cargo
from .config_bootstrap import ensure_config as _ensure_config
from . import wallet
from .startup_utils import bootstrap_all
...
def bootstrap(one_click: bool = False) -> None:
    ...
    bootstrap_all(one_click=one_click, install_optional=install_optional)
    ensure_cargo()
