...
async def test_merge_sources(monkeypatch):
    ...
    monkeypatch.setattr("solhunter_zero.discovery.fetch_trending_tokens_async", fake_trend)
    monkeypatch.setattr("solhunter_zero.discovery.stream_ranked_mempool_tokens", fake_stream)
    monkeypatch.setattr("solhunter_zero.discovery.scan_tokens_onchain", fake_onchain)
    monkeypatch.setattr("solhunter_zero.discovery.onchain_metrics.fetch_volume_onchain", fake_metric_vol)
    monkeypatch.setattr("solhunter_zero.discovery.onchain_metrics.fetch_liquidity_onchain", fake_metric_liq)
